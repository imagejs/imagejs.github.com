...
(function(){
	...
	var listOfModules={
		'Hello world':function(evt){imagejs.loadModule('https://imagejs.googlecode.com/git/helloWorld.js')},
		'Chromomarkers':function(evt){imagejs.loadModule('https://module.imagejs.googlecode.com/git/mathbiol.chromomarkers.js')},
		'Count Shapes':function(evt){imagejs.loadModules(['https://module.imagejs.googlecode.com/git/mathbiol.chromomarkers.js','https://module.imagejs.googlecode.com/git/mathbiol.countshapes.js'])},
		'KI67 analysis':function(evt){imagejs.loadModules(['https://module.imagejs.googlecode.com/git/mathbiol.chromomarkers.js','https://module.imagejs.googlecode.com/git/ki67.js'])}
	}
